...
def fill_core(input_file, rough_pf=0.5,
    ...
    crp : None or str
        Whether or not Close Random Packing (CRP) is used to roughly pack the
        bed.  To use a uniform set of grid points, use None.  To use OpenMCs
        implementation of CRP, set crp = 'openmc'.
    verbose : bool
        Whether or not to print the number of pebbles being packed.
...
def _pack_core(sim_block, element, rough_pf, crp):
    '''
...
def recirc_pebbles(input_file, init_bed_file, recirc_file, recirc_template,
    ...
    recirc_template : str
        ...
        directory.
    variable_file : str
       Filename for LAMMPS variable block file generated by
        Ghastly.
    variable_template : str
