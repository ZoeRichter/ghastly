...
def test_pf_to_n():
    ...
    test_core = ddm.core.CylCore(core_r,core_h)
...
def test_mesh_grid():
	'''
	'''
	#if you make a specific core, and feed it a delta/short list of coords
    #you should be able to hand-calculate the grid IDs with relative ease
    #and confirm the function is getting the same
...
def test_move():
    ...
    #on an axis, you should be able to hand determine exactly what move will
