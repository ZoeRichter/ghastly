...
def test_CylCore():
    ...
    assert test_cyl.zmax == 4.0
    assert test_cyl.zmin == 3.0
...
def test_ConeCore():
    ...
    assert test_cone.r_major == 1.5
    assert test_cone.r_minor == 0.5
    assert test_cone.x_c == 1.0
    assert test_cone.y_c == 2.0
    assert test_cone.zmax == 4.0
    assert test_cone.zmin == 3.0
